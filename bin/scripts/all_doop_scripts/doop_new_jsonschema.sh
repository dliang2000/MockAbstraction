...
for n in NORMAL NO_INTERPROC; do
  mkdir results/$RESULT/basic-only/java_8/jsonschema2pojo-basic-new-$n/

  mv last-analysis results/$BENCHMARK/basic-only/java_8/jsonschema2pojo-basic-new-$n/

  souffle -F last-analysis -M $n souffle-logic/analyses/mocks/mocks-after.dl -D results/$RESULT/basic-only/java_8/jsonschema2pojo-basic-new-$n/
...
for n in NORMAL NO_INTERPROC; do
  mkdir results/$RESULT/context-insensitive/java_8/jsonschema2pojo-new-$n/

  mv last-analysis results/$BENCHMARK/basic-only/java_8/jsonschema2pojo-new-$n/

  souffle -F last-analysis -M $n souffle-logic/analyses/mocks/mocks-after.dl -D results/$RESULT/context-insensitive/java_8/jsonschema2pojo-new-$n/
