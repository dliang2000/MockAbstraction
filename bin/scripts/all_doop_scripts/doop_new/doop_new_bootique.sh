...
for n in NORMAL NO_INTERPROC; do
  ...
  cp -a last-analysis results/$BENCHMARK/basic-only/java_8/bootique-basic-new-$n

  /usr/bin/time -o $HOME/souffle-basic-$BENCHMARK-$n souffle -F results/$BENCHMARK/basic-only/java_8/bootique-basic-new-$n/ -M $n souffle-logic/analyses/mocks/mocks-after.dl -D results/$BENCHMARK/basic-only/java_8/bootique-basic-new-$n/
...
for n in NORMAL NO_INTERPROC; do
  ...
  cp -a last-analysis results/$BENCHMARK/context-insensitive/java_8/bootique-new-$n

  /usr/bin/time -o $HOME/souffle-context-insensitive-$BENCHMARK-$n souffle -F results/$BENCHMARK/context-insensitive/java_8/bootique-new-$n/ -M $n souffle-logic/analyses/mocks/mocks-after.dl -D results/$BENCHMARK/context-insensitive/java_8/bootique-new-$n/
