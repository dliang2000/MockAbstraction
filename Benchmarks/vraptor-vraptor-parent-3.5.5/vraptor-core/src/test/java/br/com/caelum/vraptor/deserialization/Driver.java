...
public class Driver {
	public void runall() {
		...
		br.com.caelum.vraptor.deserialization.JsonDeserializerTest class2 = new br.com.caelum.vraptor.deserialization.JsonDeserializerTest();
		try {
			class2.setUp();
		}
		...
		try {
			class2.shouldNotAcceptMethodsWithoutArguments();
		}
		catch (java.lang.Exception err9) {
			err9.printStackTrace();
		}
		try {
			class2.shouldBeAbleToDeserializeACat();
		}
		catch (java.lang.Exception err10) {
			err10.printStackTrace();
		}
		try {
			class2.shouldBeAbleToDeserializeACatWhenMethodHasMoreThanOneArgument();
		}
		catch (java.lang.Exception err11) {
			err11.printStackTrace();
		}
		try {
			class2.shouldBeAbleToDeserializeACatWhenMethodHasMoreThanOneArgumentAndTheXmlIsTheLastOne();
		}
		catch (java.lang.Exception err12) {
			err12.printStackTrace();
		}
		try {
			class2.shouldBeAbleToDeserializeACatNamedDifferently();
		}
		catch (java.lang.Exception err13) {
			err13.printStackTrace();
		}
		class2.shouldBeAbleToDeserializeACatWhenAliasConfiguredByAnnotations();
		...
		br.com.caelum.vraptor.deserialization.DeserializesHandlerTest class4 = new br.com.caelum.vraptor.deserialization.DeserializesHandlerTest();
		try {
			class4.setUp();
		}
		...
		try {
			class4.shouldAcceptDeserializesAnnotation();
		}
		catch (java.lang.Exception err22) {
			err22.printStackTrace();
		}
		try {
			class4.shouldThrowExceptionWhenTypeIsNotADeserializer();
		}
		catch (java.lang.Exception err23) {
			err23.printStackTrace();
		}
		try {
			class4.shouldRegisterTypesOnDeserializers();
		}
