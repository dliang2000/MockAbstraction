...
with open('CallGraphEdgePackageTargetClassCounts.csv', mode='w') as outfile:
            ...
            if os.path.isfile(curr_file):
                with open(curr_file, newline='') as csvfile:
                    ...
                    for row in reader:
                        ...
                        if benchmarkRootPackageDict[benchmark] in source_clazz and target_clazz not in target_clazz_set:
